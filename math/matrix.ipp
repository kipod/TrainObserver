...
inline void Matrix::Scale( float a )
{
	*this *= a;
}
...
inline void Matrix::SetTranslation(const Vector3& v)
{
	_41 = v.x;
	_42 = v.y;
	_43 = v.z;
...
inline const Vector3& Matrix::applyToOrigin() const
{
	return (*this)[3];
}
...
inline void Matrix::SetRotationAroundVector(const Vector3& v, float angle)
{
